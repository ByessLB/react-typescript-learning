...
// ? importer les utilisateurs du fichier "/assets/data/users.tsx"
import usersData from "../../assets/data/users";
// ? ajouter le css modulaire pour cette page
...
const UsersPage = () => {
    ...
    // ? compléter ce useEffect qui se déclenche à la création du composant
    ...
    return (
        // ? faire interface graphique pour la liste des utilisateurs
